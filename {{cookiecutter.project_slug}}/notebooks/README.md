...
This should allow you to directly import `src/{{cookiecutter.project_slug}}` in your notebook.
...
Run `python -m ipykernel install --user --name="{{cookiecutter.project_slug}}"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called {{cookiecutter.project_slug}} should be available in the
